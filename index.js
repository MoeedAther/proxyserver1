...
app.post("/Changenow/transaction", async (req, res)=>{
    ...
    let result1 = await fetch(`https://api.changenow.io/v1/transactions/3016eb278f481714c943980dec2bfc595f8a2160e8eabd0228dc02cc627a184c`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
app.post("/Simpleswap/transaction", async (req, res)=>{
    ...
    let result3 = await fetch(`https://api.simpleswap.io/create_exchange?api_key=ae57f22d-7a23-4dbe-9881-624b2e147759`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
